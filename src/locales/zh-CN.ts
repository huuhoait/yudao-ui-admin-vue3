export default {
  ...
  sys: {
    ...
    user: {
      ...
      enable: '启用',
      disable: '停用',
      confirmChangeStatus: '确认要"{status}""{username}"用户吗?',
      userManagement: '用户管理',
      userImport: '用户导入',
      userExport: '用户导出',
      userDelete: '用户删除',
      ...
      userDetail: '用户详情',
      userAssignRole: '分配角色',
      userImportSuccess: '导入成功',
      userImportFail: '导入失败',
      userImportTip: '提示：导入用户时，如果用户已存在则更新，否则新增',
      avatar: '头像',
      avatarUpload: '上传头像',
      dept: '部门',
      posts: '岗位',
    ...
    notify: {
      ...
      my: {
        ...
        markAsRead: '已读',
        markAllAsRead: '全部已读',
        markSelectedAsRead: '批量已读',
        readSuccess: '全部已读成功！',
        batchReadSuccess: '批量已读成功！',
        myNotifyMessageManagement: '我的站内信管理'
      },
      template: {
        title: '站内信模板',
        code: '模板编码',
        ...
        notifyTemplateManagement: '站内信模板管理'
      }
    },
    mail: {
      title: '邮件管理',
      account: {
        ...
        usernamePlaceholder: '请输入用户名',
        passwordPlaceholder: '请输入密码',
        hostPlaceholder: '请输入SMTP服务器域名',
        portPlaceholder: '请输入SMTP服务器端口',
        mailRequired: '邮箱不能为空',
        mailInvalid: '请输入正确的邮箱地址',
        usernameRequired: '用户名不能为空',
        passwordRequired: '密码不能为空',
        hostRequired: 'SMTP服务器域名不能为空',
        portRequired: 'SMTP服务器端口不能为空',
        mailAccountManagement: '邮件账号管理'
      },
      log: {
        title: '邮件日志',
        id: '编号',
      ...
      template: {
        ...
        mailTemplateManagement: '邮件模板管理',
        testSuccess: '提交发送成功！发送结果，见发送日志编号：'
      }
    },
    area: {
      title: '地区管理',
    ...
    operatelog: {
      ...
      reset: '重置',
      export: '导出',
      userIdPlaceholder: '请输入操作人员',
      typePlaceholder: '请输入操作模块',
      subTypePlaceholder: '请输入操作名',
      actionPlaceholder: '请输入操作内容',
      bizIdPlaceholder: '请输入业务编号',
      startTimePlaceholder: '开始日期',
      endTimePlaceholder: '结束日期',
      operateLogManagement: '操作日志管理'
    },
    notice: {
      title: '通知公告',
      noticeTitle: '公告标题',
    ...
    dict: {
      ...
      codePlaceholder: '请输入字典类型',
      nameRequired: '字典名称不能为空',
      codeRequired: '字典类型不能为空',
      dictManagement: '字典管理',
      dictTypeManagement: '字典类型管理',
    ...
    dept: {
      ...
      codePlaceholder: '请输入部门编号',
      phonePlaceholder: '请输入联系电话',
      emailPlaceholder: '请输入邮箱',
      leaderPlaceholder: '请输入负责人',
      remarkPlaceholder: '请输入备注',
      nameRequired: '部门名称不能为空',
      codeRequired: '部门编号不能为空',
      phoneInvalid: '请输入正确的联系电话',
      emailInvalid: '请输入正确的邮箱地址',
      sortRequired: '显示排序不能为空',
    ...
    menu: {
      ...
      pathTip: '访问的路由地址，如：`user`。如需外网地址时，则以 `http(s)://` 开头',
    ...
    role: {
      ...
      deptScope: '部门范围',
      linkParentChild: '父子联动(选中父节点，自动选择子节点)',
  ...
  insertFieldPlaceholder: '请插入表单字段（输入 "\\{" 可以选择表单字段）或输入文本',
        ...
        timeNone: '无',
        accurateToDay: '精确到天',
        accurateToHour: '精确到小时',
        accurateToMinute: '精确到分钟',
        accurateToSecond: '精确到秒',
        processNameField: '流程名称',
        startTimeField: '开始时间',
        initiatorField: '发起人',
        basicInfo: '基本信息',
        formDesign: '表单设计',
