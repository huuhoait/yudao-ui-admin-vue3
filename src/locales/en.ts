export default {
  ...
  sys: {
    ...
    user: {
      ...
      postIds: 'Post',
      postIdsPlaceholder: 'Please select post(s)',
      remark: 'Remark',
      ...
      role: 'Role',
      rolePlaceholder: 'Please select role(s)',
      searchDept: 'Department Name',
      enable: 'Enable',
      disable: 'Disable',
      confirmChangeStatus: 'Are you sure you want to "{status}" user "{username}"?',
    ...
    notify: {
      ...
      message: {
        ...
        search: 'Search',
        reset: 'Reset',
        notifyMessageManagement: 'Notification Management'
      },
      my: {
        ...
        readSuccess: 'All marked as read successfully!',
        batchReadSuccess: 'Batch marked as read successfully!',
        myNotifyMessageManagement: 'My Notification Management'
      },
      template: {
        ...
        sendSuccess: 'Sent successfully! See send log ID: ',
        notifyTemplateManagement: 'Notification Template Management'
      }
    },
    mail: {
      ...
      account: {
        ...
        usernameRequired: 'Username is required',
        passwordRequired: 'Password is required',
        hostRequired: 'SMTP server domain is required',
        portRequired: 'SMTP server port is required',
        mailAccountManagement: 'Mail Account Management'
      },
      log: {
        title: 'Mail Log',
        id: 'ID',
        ...
        operation: 'Operation',
        detail: 'Detail',
        mailLogManagement: 'Mail Log Management'
      },
      template: {
        title: 'Mail Template',
        code: 'Template Code',
        ...
        nicknamePlaceholder: 'Please enter sender name',
        remarkPlaceholder: 'Please enter remark',
        mailPlaceholder: 'Please enter recipient email',
        mailRequired: 'Email is required',
        templateCodeRequired: 'Template code is required',
        paramRequired: 'Parameter {param} is required',
        codeRequired: 'Template code is required',
        nameRequired: 'Template name is required',
        accountIdRequired: 'Email account is required',
        contentRequired: 'Template content is required',
        paramsRequired: 'Parameters are required',
        statusRequired: 'Status is required',
        mailTemplateManagement: 'Mail Template Management',
        testSuccess: 'Successfully submitted for sending! Send result, see send log ID: '
      }
    },
    area: {
      ...
      resultPlaceholder: 'Display IP query result',
    ...
    operatelog: {
      ...
      reset: 'Reset',
      export: 'Export',
      userIdPlaceholder: 'Please enter operator',
      typePlaceholder: 'Please enter operation module',
      subTypePlaceholder: 'Please enter operation name',
      actionPlaceholder: 'Please enter operation content',
      bizIdPlaceholder: 'Please enter business ID',
      startTimePlaceholder: 'Start date',
      endTimePlaceholder: 'End date',
      operateLogManagement: 'Operation Log Management'
    },
    notice: {
      title: 'Notice',
      ...
      pushConfirm: 'Do you want to push the selected notice?'
    },
    loginlog: {
      title: 'Login Log',
      logId: 'Log ID',
      ...
      userIpPlaceholder: 'Please enter login IP',
      startTimePlaceholder: 'Start date',
      endTimePlaceholder: 'End date',
      loginLogManagement: 'Login Log Management'
    },
    commonSystem: {
      title: 'Common System Management',
      notice: 'Notice',
    ...
    dict: {
      ...
      typeStatus: 'Dictionary Status',
      dataValue: 'Dictionary Value',
      dataLabel: 'Dictionary Label',
      dataDictType: 'Dictionary Type',
      dataStatus: 'Dictionary Status',
      dataType: 'Display Type',
      dataColor: 'Color Style',
      dataCreateTime: 'Create Time',
      dataSort: 'Display Order',
      dataRemark: 'Remark',
      dataParentId: 'Parent Dictionary',
      operation: 'Operation',
      namePlaceholder: 'Please enter dictionary name',
      codePlaceholder: 'Please enter dictionary type',
      nameRequired: 'Dictionary name is required',
      codeRequired: 'Dictionary type is required',
      dictManagement: 'Dictionary Management',
      dictTypeManagement: 'Dictionary Type Management',
      dictDataManagement: 'Dictionary Data Management',
      dictAdd: 'Add Dictionary',
      dictEdit: 'Edit Dictionary',
      dictDelete: 'Delete Dictionary',
      dataAdd: 'Add Data',
      dataEdit: 'Edit Data',
    ...
    menu: {
      name: 'Menu Name',
      inputName: 'Please enter menu name',
      status: 'Menu Status',
      selectStatus: 'Please select menu status',
      search: 'Search',
      reset: 'Reset',
      create: 'Create',
      ...
      pathTip:
        'The route address to access, e.g., `user`. For external addresses, start with `http(s)://`',
      // Add other keys as needed for all labels, placeholders, tooltips, etc.

      statusRequired: 'Menu status is required'
      // Add more keys as needed for other Chinese text in the file
    },
    role: {
      ...
      assignMenu: 'Assign Menu Permission',
  ...
  bpm: {
    ...
    model: {
      ...
      form: {
        ...
        timeNone: 'None',
        accurateToDay: 'Accurate to day',
        accurateToHour: 'Accurate to hour',
        accurateToMinute: 'Accurate to minute',
        accurateToSecond: 'Accurate to second',
        processNameField: 'Process Name',
        startTimeField: 'Start Time',
        initiatorField: 'Initiator',
        basicInfo: 'Basic Information',
