<template>
  <div class="end-node-wrapper">
    <div
      ...
      @click="nodeClick"
    >
      <span class="node-fixed-name" :title="t('bpm.processDesigner.endEvent.title')">{{
        t('bpm.processDesigner.endEvent.title')
      }}</span>
    </div>
  </div>
  <el-dialog
    :title="t('bpm.processDesigner.endEvent.approvalInfo')"
  ...
  >
    <el-row>
      ...
      >
        ...
        />
        <el-table-column
          :label="t('bpm.processDesigner.endEvent.table.department')"
          min-width="100"
          align="center"
        >
        ...
        <el-table-column
          align="center"
          :label="t('bpm.processDesigner.endEvent.table.approvalStatus')"
          prop="status"
          min-width="90"
        >
          <template #default="scope">
        ...
        <el-table-column
          align="center"
          :label="t('bpm.processDesigner.endEvent.table.duration')"
