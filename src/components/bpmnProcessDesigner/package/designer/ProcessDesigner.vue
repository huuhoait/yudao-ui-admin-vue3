    ...
    <div class="my-process-designer__header" style="z-index: 999; display: table-row-group">
      ...
      <template v-if="!$slots['control-header']">
        ...
        <ElButtonGroup key="scale-control">
          ...
          <el-tooltip effect="light" content="Reset & Center View">
...
// 翻译方法
// Không nạp plugins/translate/zh.js: bảng đó dịch nhãn gốc của bpmn-js sang tiếng Trung.
// Truyền bảng rỗng -> customTranslate trả lại nguyên văn, tức dùng TIẾNG ANH gốc của bpmn-js.
// Vẫn giữ prop `translations` để nơi gọi tự cấp bảng dịch khi cần.
