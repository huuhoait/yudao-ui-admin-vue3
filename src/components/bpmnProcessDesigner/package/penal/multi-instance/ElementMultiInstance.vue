  ...
  <div class="panel-tab__content">
    ...
    <el-form label-width="90px" style="display: none">
      <el-form-item label="Quick Config">
        <el-button size="small" @click="changeConfig('依次审批')">Approve in sequence</el-button>
        <el-button size="small" @click="changeConfig('会签')">Countersign</el-button>
        <el-button size="small" @click="changeConfig('或签')">Or-sign</el-button>
      </el-form-item>
