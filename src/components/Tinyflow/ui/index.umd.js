    ...
    wr = (We, Je, ot) =>
      Je.has(We)
        ...
        : Je instanceof WeakSet
          ...
          : Je.set(We, ot),
    zo = (We, Je, ot, Ro) => (
      ba(We, Je, 'write to private field'),
      Ro ? Ro.call(We, ot) : Je.set(We, ot),
      ot
    ),
...
\r\f \v\uFEFF`
    ...
    return (
      ...
      function (E, T) {
        if (arguments.length > 0) {
          ...
          return (
            b.equals(D) || ((_ = !0), U(v, D), p && d !== void 0 && (d = D), yn(() => h(b))),
            E
          )
        }
        return h(b)
  ...
  Vs(
    ...
    Ol(co, {
      brighter(e) {
        return (
          (e = e == null ? hi : Math.pow(hi, e)),
          new sn(this.h, this.s, this.l * e, this.opacity)
        )
      },
      darker(e) {
        return (
  ...
  function gu() {
    ...
    function D(S, ...M) {
      ...
      function se(ee) {
        ;(H.on('mousemove.zoom mouseup.zoom', null),
          Ll(ee.view, P.moved),
          wo(ee),
          P.event(ee).end())
      }
  ...
  function v0(e, t, n, r, o) {
    ...
    switch (n) {
      ...
      case $e.Bottom:
        ...
        break
      case $e.Left:
        ;((s = [e.x * t.zoom + t.x - r, (e.y + e.height * i) * t.zoom + t.y]),
          (a = [-100, -100 * i]))
        break
    }
            ...
            Ee(() => {
              ;(de(u, 'style', 'pointer-events: all;' + n()),
                at(
                  u,
                  'transform',
                  `translate(-50%, -50%) translate(${r() ?? ''}px,${o() ?? ''}px)`
                ))
            }),
            Ze('keyup', u, () => {}),
            Ze('click', u, () => {
  ...
  function Lt() {
    ...
    return {
      ...
      fitBounds: async (b, N) => {
        ...
        return (
          await E.setViewport(T, { duration: N == null ? void 0 : N.duration }),
          Promise.resolve(!0)
        )
      },
  ...
  function Pt(e, t) {
    ...
    Wf(r)
    let o
    ;(Ee(() => (o = nn(r, o, { ...n, class: `tf-textarea nodrag ${t.class ?? ''}` }))),
      L(e, r),
      ce())
  }
  ie(Pt, {}, [], [], !0)
