<template>
  <doc-alert :title="t('sys.mail.template.mailTemplateManagement')" url="https://doc.iocoder.cn/mail" />
  ...
  <ContentWrap>
    <Search :schema="allSchemas.searchSchema" @search="setSearchParams" @reset="setSearchParams">
      ...
      <template #actionMore>
        ...
        >
          <Icon icon="ep:plus" class="mr-5px" /> {{ t('sys.mail.template.create') }}
        </el-button>
        <el-button
          type="danger"
          plain
...
import { getSchemas } from './template.data'
