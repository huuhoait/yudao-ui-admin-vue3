  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle">
    ...
    >
      <el-form-item :label="t('system.sms.channel.smsSignature')" prop="signature">
        <el-input v-model="formData.signature" :placeholder="t('system.sms.channel.inputSmsSignature')" />
      </el-form-item>
      <el-form-item :label="t('system.sms.channel.channelCode')" prop="code">
        <el-select v-model="formData.code" clearable :placeholder="t('system.sms.channel.selectChannelCode')">
          <el-option
