<template>
  <Dialog v-model="dialogVisible" :max-height="500" :scroll="true" :title="t('system.notify.my.messageDetail')">
    <el-descriptions :column="1" border>
      <el-descriptions-item :label="t('system.notify.my.sender')">
        {{ detailData.templateNickname }}
      </el-descriptions-item>
      <el-descriptions-item :label="t('system.notify.my.sendTime')">
        {{ formatDate(detailData.createTime) }}
      </el-descriptions-item>
      <el-descriptions-item :label="t('system.notify.my.messageType')">
        <dict-tag :type="DICT_TYPE.SYSTEM_NOTIFY_TEMPLATE_TYPE" :value="detailData.templateType" />
      </el-descriptions-item>
      <el-descriptions-item :label="t('system.notify.my.read')">
      ...
      <el-descriptions-item :label="t('system.notify.my.content')">
