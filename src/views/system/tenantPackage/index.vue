<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item :label="t('common.status')" prop="status">
        <el-select v-model="queryParams.status" :placeholder="t('system.tenantPackage.selectStatus')" clearable class="!w-240px">
          <el-option
      ...
      <el-form-item :label="t('common.createTime')" prop="createTime">
        <el-date-picker
          ...
          :start-placeholder="t('system.tenantPackage.startDate')"
          :end-placeholder="t('system.tenantPackage.endDate')"
          class="!w-240px"
        />
      </el-form-item>
      <el-form-item>
        ...
        >
          ...
          {{ t('system.tenantPackage.deleteBatch') }}
        </el-button>
      </el-form-item>
    </el-form>
  </ContentWrap>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      />
      <el-table-column :label="t('system.tenantPackage.action')" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button
            link
            type="primary"
