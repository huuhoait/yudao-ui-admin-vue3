    ...
    >
      <el-form-item :label="t('infra.demo.demo03.normal.name')" prop="name">
        <el-input
          ...
          :placeholder="t('infra.demo.demo03.normal.inputName')"
          clearable
      ...
      <el-form-item :label="t('common.createTime')" prop="createTime">
        <el-date-picker
          ...
          type="daterange"
          :start-placeholder="t('infra.demo.demo03.normal.startDate')"
          :end-placeholder="t('infra.demo.demo03.normal.endDate')"
      ...
      <el-form-item>
        ...
        >
          <Icon icon="ep:plus" class="mr-5px" /> {{ t('infra.demo.demo03.normal.create') }}
        </el-button>
        <el-button
          type="success"
          plain
        ...
        >
          <Icon icon="ep:download" class="mr-5px" /> {{ t('infra.demo.demo03.normal.export') }}
        </el-button>
        <el-button
          type="danger"
          plain
        ...
        >
          <Icon icon="ep:delete" class="mr-5px" /> {{ t('infra.demo.demo03.normal.deleteBatch') }}
        </el-button>
      </el-form-item>
    </el-form>
  </ContentWrap>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column
        ...
        width="180px"
      />
      <el-table-column :label="t('infra.demo.demo03.normal.action')" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            link
            type="primary"
          ...
          >
            {{ t('infra.demo.demo03.normal.edit') }}
          </el-button>
          <el-button
            link
            type="danger"
            ...
            v-hasPermi="['infra:demo03-student:delete']"
          >
            {{ t('infra.demo.demo03.normal.delete') }}
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, t('infra.demo.demo03.normal.exportFileName'))
  } catch {
  } finally {
