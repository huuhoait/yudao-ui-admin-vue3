<template>
  ...
  >
    <el-table :data="formData" class="-mt-10px">
      ...
      <el-table-column :label="t('infra.demo.demo03.inner.components.name')" min-width="150">
        <template #default="{ row, $index }">
          <el-form-item :prop="`${$index}.name`" :rules="formRules.name" class="mb-0px!">
            <el-input v-model="row.name" :placeholder="t('infra.demo.demo03.inner.components.inputName')" />
          </el-form-item>
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" fixed="right" :label="t('infra.demo.demo03.inner.components.action')" width="60">
